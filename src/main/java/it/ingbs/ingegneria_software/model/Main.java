...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            GestoreMenu sistemaGenerale = new GestoreMenu(gestoreGerarchie, gestoreFattori, gestoreComprensorio);
            ...
            do {
                ...
                switch (opzione) {
                    ...
                    case 2:
                        //da implementare: menuAccesso.menuFruitore(sistemaGenerale);
                        break;
                }
            } while (opzione != 0);
